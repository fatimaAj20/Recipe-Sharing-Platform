...
namespace RecipeSharingProject.Client.Pages.Recipe
{
    ...
    public class RecipeModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            RecipeCreate recipeCreate = new RecipeCreate(Request.Form["Name"], ingredients, steps, AuthenticationUtils.GetEmail(User), Request.Form["Cuisine"], int.Parse(Request.Form["TimeNeeded"]), int.Parse(Request.Form["Serving"]), int.Parse(Request.Form["Calories"]), double.Parse(Request.Form["Fat"]), double.Parse(Request.Form["SturatedFat"]), double.Parse(Request.Form["TransFat"]), int.Parse(Request.Form["Cholesterol"]), int.Parse(Request.Form["Sodium"]), double.Parse(Request.Form["Carbohydrates"]), double.Parse(Request.Form["Fiber"]), double.Parse(Request.Form["Sugars"]), double.Parse(Request.Form["Protein"]), Request.Form["ServingSize"], RecipePicture);
